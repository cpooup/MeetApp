    ...
    $scope.login = function () {
     if ($localStorage.hasOwnProperty("accessToken") === true) {
             ...
             $cordovaOauth.facebook("115777701818035", ["email", "public_profile", "user_friends"]).then(function (result) {
                        ...
                        $http.get("https://graph.facebook.com/v2.2/me", {params: {access_token: $localStorage.FBaccessToken, fields: "id,name,gender,location,website,picture,relationship_status,friends", format: "json"}}).then(function (result) {
                                                    console.log("result graph" + JSON.stringify(result));
                                                    $localStorage.FBProfileData = result.data;
